...
I spend days, weeks, and sometimes months working on my projects, with hunderds of backups for each and every edit. I carefully research the code base i am working with, setup a project workspace, reference files, and a test space. I go through testing every detail trying not to overlook anything. With something like the Co-Op mod i was working on, that is 21 different hand cosmetics, over every item, in different positions, states, and more. I have 60 hours in game spent just staring at just the fucking hand cosmetics. Yet my effort gets lumped in with "ai generated" and brushed off. I refuse to put any more effort or support into a game that has decided that i am a devil, and that all my words are lies. In the co-op mod alone i have over 202 backups and edits. That is not even the 3 times i lost a lot of work needing to backdate or redo from scratch the code due to not realizing the scope i needed to do was bigger then i originally thought. As such before is spend another 200-1000 rounds worth of edits and backups working on a project i thought would be fun, just to have it thrown in the trash by someone else. I am stopping here.

If you were waiting for the co-op mod i apologize, but again i cannot support a dev who indirectly calls me a liar over my disability.
